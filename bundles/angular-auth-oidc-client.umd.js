(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@angular/common/http'), require('rxjs'), require('jsrsasign-reduced'), require('rxjs/operators'), require('common-tags'), require('@angular/router')) :
    typeof define === 'function' && define.amd ? define('angular-auth-oidc-client', ['exports', '@angular/common', '@angular/core', '@angular/common/http', 'rxjs', 'jsrsasign-reduced', 'rxjs/operators', 'common-tags', '@angular/router'], factory) :
    (global = global || self, factory(global['angular-auth-oidc-client'] = {}, global.ng.common, global.ng.core, global.ng.common.http, global.rxjs, global['jsrsasign-reduced'], global.rxjs.operators, global['common-tags'], global.ng.router));
}(this, (function (exports, common, core, http, rxjs, jsrsasignReduced, operators, commonTags, router) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var StoragePersistanceService = /** @class */ (function () {
        ...
        StoragePersistanceService.prototype.resetAuthStateInStorage = function () {
            this.store(this.storageAuthorizedState, exports.AuthorizedState.Unknown);
    ...
    var AuthStateService = /** @class */ (function () {
        function AuthStateService(storagePersistanceService, loggerService, publicEventsService, configurationProvider, tokenValidationService) {
            ...
            this.authState = exports.AuthorizedState.Unknown;
        }
        ...
        AuthStateService.prototype.setAuthorizedAndFireEvent = function () {
            ...
            this.authState = exports.AuthorizedState.Authorized;
        ...
        AuthStateService.prototype.setUnauthorizedAndFireEvent = function () {
            // set the correct values in storage
            this.authState = exports.AuthorizedState.Unauthorized;
        ...
        AuthStateService.prototype.initStateFromStorage = function () {
            ...
            if (currentAuthorizedState === exports.AuthorizedState.Authorized) {
                this.authState = exports.AuthorizedState.Authorized;
            }
            else {
                this.authState = exports.AuthorizedState.Unknown;
        ...
        AuthStateService.prototype.getAccessToken = function () {
            if (!(this.authState === exports.AuthorizedState.Authorized)) {
                return '';
            }
        ...
        AuthStateService.prototype.areAuthStorageTokensValid = function () {
            ...
            if (currentAuthState !== exports.AuthorizedState.Authorized) {
                return false;
            }
    ...
    var OidcConfigService = /** @class */ (function () {
        ...
        OidcConfigService.prototype.withConfig = function (passedConfig) {
            ...
            var loadConfig$ = this.getWellKnownDocument(passedConfig.authWellknownEndpoint).pipe(operators.map(function (wellKnownEndpoints) {
                return {
            ...
            }), operators.tap(function (mappedWellKnownEndpoints) { return _this.configurationProvider.setConfig(passedConfig, mappedWellKnownEndpoints); }), operators.tap(function (mappedWellKnownEndpoints) {
                return _this.publicEventsService.fireEvent(exports.EventTypes.ConfigLoaded, { passedConfig: passedConfig, mappedWellKnownEndpoints: mappedWellKnownEndpoints });
            }));
    ...
    var UrlService = /** @class */ (function () {
        ...
        UrlService.prototype.createBodyForCodeFlowRefreshTokensRequest = function (refreshtoken) {
            ...
            return commonTags.oneLineTrim(templateObject_4 || (templateObject_4 = __makeTemplateObject(["grant_type=refresh_token\n          &client_id=", "\n          &refresh_token=", ""], ["grant_type=refresh_token\n          &client_id=", "\n          &refresh_token=", ""])), clientId, refreshtoken);
        };
    ...
    var FlowsService = /** @class */ (function () {
        ...
        FlowsService.prototype.processCodeFlowCallback = function (urlToCheck) {
            var _this = this;
            return this.codeFlowCallback(urlToCheck).pipe(operators.switchMap(function (callbackContext) { return _this.codeFlowCodeRequest(callbackContext); }), operators.switchMap(function (callbackContext) { return _this.codeFlowSilentRenewCheck(callbackContext); }), operators.switchMap(function (callbackContext) { return _this.callbackHistoryAndResetJwtKeys(callbackContext); }), operators.switchMap(function (callbackContext) { return _this.callbackStateValidation(callbackContext); }), operators.switchMap(function (callbackContext) { return _this.callbackUser(callbackContext); }));
        };
        FlowsService.prototype.processSilentRenewCodeFlowCallback = function (firstContext) {
            var _this = this;
            return this.codeFlowCodeRequest(firstContext).pipe(operators.switchMap(function (callbackContext) { return _this.codeFlowSilentRenewCheck(callbackContext); }), operators.switchMap(function (callbackContext) { return _this.callbackHistoryAndResetJwtKeys(callbackContext); }), operators.switchMap(function (callbackContext) { return _this.callbackStateValidation(callbackContext); }), operators.switchMap(function (callbackContext) { return _this.callbackUser(callbackContext); }));
        };
        ...
        FlowsService.prototype.processRefreshToken = function () {
            var _this = this;
            return this.refreshSessionWithRefreshTokens().pipe(operators.switchMap(function (callbackContext) { return _this.refreshTokensRequestTokens(callbackContext); }), operators.switchMap(function (callbackContext) { return _this.codeFlowSilentRenewCheck(callbackContext); }), operators.switchMap(function (callbackContext) { return _this.callbackHistoryAndResetJwtKeys(callbackContext); }), operators.switchMap(function (callbackContext) { return _this.callbackStateValidation(callbackContext); }), operators.switchMap(function (callbackContext) { return _this.callbackUser(callbackContext); }));
        };
        // STEP 1 Code Flow
        ...
        FlowsService.prototype.refreshTokensRequestTokens = function (callbackContext) {
            ...
            return this.dataService.post(tokenRequestUrl, data, headers).pipe(operators.switchMap(function (response) {
        ...
        FlowsService.prototype.codeFlowCodeRequest = function (callbackContext) {
            ...
            return this.dataService.post(tokenRequestUrl, bodyForCodeFlow, headers).pipe(operators.switchMap(function (response) {
                var authResult = new Object();
                authResult = response;
                authResult.state = callbackContext.state;
    ...
    var RedirectService = /** @class */ (function () {
        ...
        RedirectService.ɵprov = core.ɵɵdefineInjectable({ factory: function RedirectService_Factory() { return new RedirectService(core.ɵɵinject(WINDOW)); }, token: RedirectService, providedIn: "root" });
    ...
    var CallbackService = /** @class */ (function () {
        ...
        CallbackService.prototype.startTokenValidationPeriodically = function (repeatAfterSeconds) {
            ...
            var periodicallyCheck$ = rxjs.interval(millisecondsDelayBetweenTokenCheck).pipe(operators.switchMap(function () {
        ...
        CallbackService.prototype.refreshSessionWithRefreshTokens = function () {
            ...
            return this.flowsService.processRefreshToken().pipe(operators.catchError(function (error) {
                if (!_this.configurationProvider.openIDConfiguration.triggerAuthorizationResultEvent /* TODO && !this.isRenewProcess */) {
                    _this.router.navigate([_this.configurationProvider.openIDConfiguration.unauthorizedRoute]);
                }
                _this.stopPeriodicallTokenCheck();
        ...
        CallbackService.ɵprov = core.ɵɵdefineInjectable({ factory: function CallbackService_Factory() { return new CallbackService(core.ɵɵinject(UrlService), core.ɵɵinject(FlowsService), core.ɵɵinject(FlowHelper), core.ɵɵinject(ConfigurationProvider), core.ɵɵinject(router.Router), core.ɵɵinject(FlowsDataService), core.ɵɵinject(LoggerService), core.ɵɵinject(SilentRenewService), core.ɵɵinject(UserService), core.ɵɵinject(AuthStateService)); }, token: CallbackService, providedIn: "root" });
    ...
    var OidcSecurityService = /** @class */ (function () {
        ...
        OidcSecurityService.prototype.checkAuth = function () {
            ...
            return this.callbackService.handlePossibleStsCallback(currentUrl).pipe(operators.map(function () {
    ...
    exports.ɵd = HttpBaseService;
    exports.ɵe = FlowHelper;
    exports.ɵf = CheckSessionService;
    exports.ɵg = StoragePersistanceService;
    exports.ɵh = IFrameService;
    exports.ɵi = SilentRenewService;
    exports.ɵj = UserService;
    exports.ɵk = UrlService;
    exports.ɵl = _window;
    exports.ɵm = WINDOW;
    exports.ɵn = FlowsDataService;
    exports.ɵo = RandomService;
    exports.ɵp = AuthStateService;
    exports.ɵq = FlowsService;
    exports.ɵr = SigninKeyDataService;
    exports.ɵs = StateValidationService;
    exports.ɵt = CallbackService;
    exports.ɵu = LogoffRevocationService;
    exports.ɵv = RedirectService;
    exports.ɵw = EqualityService;
    exports.ɵx = BrowserStorageService;
